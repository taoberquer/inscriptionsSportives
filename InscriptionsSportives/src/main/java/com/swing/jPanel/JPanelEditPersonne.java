...
public class JPanelEditPersonne extends JPanelEdit {

	private static final long serialVersionUID = 2961069326258350774L;
	 ...
	 * Create the panel.
	 */
	public JPanelEditPersonne(Personne passedPersonne) {
		personne = passedPersonne;
		
		jTextEmail.setText(personne.getMail());
		jTextName.setText(personne.getNom());
		jTextFirstname.setText(personne.getPrenom());
	...
	protected void update() {
		personne.setMail(jTextEmail.getText());
		personne.setNom(jTextName.getText());
		personne.setPrenom(jTextFirstname.getText());
